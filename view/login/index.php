        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <a href="../halaman"><img src="../../assets/img/avatar/spendasi_icon.png" alt="logo" width="100" class="shadow-light rounded-circle"></a>
            </div>
            ...
            <div class="simple-footer">
              Copyright &copy; Pemweb B Kelompok 10 IF UPNVJT 2024
            </div>
          </div>
        </div>
      </div>
