...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="../../assets/img/avatar/spendasi_icon.png">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">SMP NEGERI 2 SIDOARJO<span class="text-primary">.</span></a>
            </div>
            <div class="site-quick-contact d-none d-lg-flex ml-auto ">
              <div class="d-flex site-info align-items-center mr-5">
                <span class="block-icon mr-3"><span class="icon-map-marker text-yellow"></span></span>
                <span>Jl. Raya Ponti,  Sidoarjo, <br> Jawa Timur 61211</span>
              </div>
    ...
    <div class="ftco-blocks-cover-1">
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/spendasi_hero.jpg')">
        <div class="container">
          <div class="row align-items-center ">
            ...
            <div class="col-md-5 mt-5 pt-5">
              ...
              <p>Sekolah ini memiliki prestasi bagus di bidang olahraga. Terutama, olahraga Futsal dan Basket. Maka dari itu, SMP Negeri 2 Sidoarjo banyak mengeluarkan wakil-wakilnya dalam Turnamen olahraga.</p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <span class="text-cursive h5 text-red d-block">Galeri Spendasi</span>
            <h2 class="text-black">Sekolah Sang Juara</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp_4.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp_4.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp_2.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp_2.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp_3.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp_3.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp_4.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp_4.jpg" alt="Image" class="img-fluid"></a>
          </div>
          ...
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp_2.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp_3.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp_2.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp_2.jpg" alt="Image" class="img-fluid"></a>
          </div>
    ...
    <footer class="site-footer" style="padding: 20px 0 5px 0">
      <div class="container">
        <p class="text-center"> Created by : Pemweb B Kelompok 10 IF UPNVJT 2024</p>
      </div>
    </footer>
